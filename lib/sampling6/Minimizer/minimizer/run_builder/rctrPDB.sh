...
foreach PROT (/root/mydisk/sampl6/Codes_sampling/Tools/Results/pdb/1E6E/1E6E_A.pdb)
set PROT1 = ${PROT:t:r}
...
foreach PROTT (/root/mydisk/sampl6/Codes_sampling/Tools/Results/pdb/1E6E/1E6E_B_rota430.pdb)
set PROT2 = ${PROTT:t:r}
