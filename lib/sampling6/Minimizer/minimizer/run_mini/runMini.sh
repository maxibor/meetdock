...
# loop on REC
#============ 
foreach PROT ('\ls $SEPDIR//root/mydisk/sampl6/Codes_sampling/Tools/Results/pdb/1E6E/1E6E_A.pdb')
set PROT1={$PROT:t:r}
echo $PROT1
set PROTNAME1=$PROT1
...
# loop on LIG
#============
foreach PROTT ('\ls $SEPDIR//root/mydisk/sampl6/Codes_sampling/Tools/Results/pdb/1E6E/1E6E_B_rota430.pdb')
set PROT2={$PROTT:t:r}
set PROTNAME2=$PROT2
