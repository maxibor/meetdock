...
public class PdbFileTransform1 extends FileIO
{
    ...
    public PdbFileTransform1(String fileName)
    {
	this.fileName=fileName;
	
    }
    
    public PdbFileTransform1(String fileName, String suffix)
    {
	this.fileName=fileName;
	this.suffix=suffix;
    }
    ...
    public PdbFileTransform1(String fileName, String suffix, Vector values)
    {
	this.fileName=fileName;
	this.values=values;
	this.suffix=suffix;
    ...
    public PdbFileTransform1(String fileName, String suffix, Vector values, int unite)
    {
	this.fileName=fileName;
	this.values=values;
	this.suffix=suffix;
